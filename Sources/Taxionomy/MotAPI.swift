...
public struct MotAPI: View {
    @State var mot = Mot("chose", "choses", .f)
    @State var nompropre = "Boris Goudounov"
    @State var ligne = "une ligne courte"
    @State var simple = 0
